...
<!-- Meta Tags -->
<title>Chapman Sound - Portfolio</title>

<meta name="description" content="Jacob Chapman is a professional audio, video, and lighting engineer with over ten years of professional experience. You can view some examples of his work here.">
<meta name="keywords" content="jacob, chapman, north alabama, huntsville, producer, audio, sound, soundboard, lighting, video, AV, production, automation, mixing, events">
<meta name="publisher" content="Jacob Chapman">
<meta name="language" content="English">
<meta name="copyright" content="(c)2026 all rights reserved">
...
<!-- Google Fonts Embed -->
<link href="https://fonts.googleapis.com/css?family=Open+Sans|Raleway:400,800,900" rel="stylesheet">
<!------------------------->
...
<div class="page-wrap">
	...
	<div class="site-header">
		<span class="boxed" align='center'>
			<a class="nav" href="/php/index.php">
				&nbsp;Back&nbsp;
			</a>
		</span>
	</div>
	...
	<main class="page-content">
		...
		<section class="transbox">
			...
			<div class="experience-body">
				<h3 class="subheader">IATSE Local 900, Huntsville, AL</h3>
				<img src='images/ia900.png' alt="Logo of IATSE Local 900" class="logo-iatse">
				<p>The Orion Amphitheatre, as Stagehand:<br>
					Jack White, Chris Stapleton, The Black Crowes, Dierks Bentley, Dave Matthews Band</p>
				<p>Von Braun Center, as Stagehand:<br>
				Shinedown w/ Three Days Grace, Chris Tomlin & MercyMe, Broadway Theater League's Anastasia, The Judds, Ghost w/ Mastodon and Spiritbox, Elevation Worship Summer Tour 2022</p>
			</div>
		</section>
		...
		<section class="transbox">
			...
			<div class="experience-body"> 	
				...
				<div class="full-content">
					<img src='images/fbcbroadcast_thumb.jpg' alt="FBC Decatur Broadcast Studio"></a>
				</div>
			...
			<div class="badge-grid">
				<a href='/php/images/fbcgraphics1.jpg' target='_blank'><img src="images/fbcgraphics1.jpg" alt="Brass Band of Huntsville, 2019 Christmas Concert" class="badge-item thumb-rect"></a>
				<a href='/php/images/fbcgraphics2.jpg' target="_blank"><img src="images/fbcgraphics2.jpg" alt="A Chapel Listening Session, 2021" class="badge-item thumb-rect"></a> 
				<a href='/php/images/fbcgraphics3.jpg' target="_blank"><img src="images/fbcgraphics3.jpg" alt="Ordination of Minister to Students" class="badge-item thumb-rect"></a> 
				<a href='/php/images/fbcgraphics4.jpg' target="_blank"><img src="images/fbcgraphics4.jpg" alt="Student Choir Rehearsals, Summer 2021" class="badge-item thumb-rect"></a> 
				<a href='/php/images/fbcgraphics5.jpg' target="_blank"><img src="images/fbcgraphics5.jpg" alt="Choir and Orchestra Rehearsals, Spring 2021" class="badge-item thumb-rect"></a> 
		...
		<section class="transbox">
			<div class="photo-caption">
				And in case you were wondering, yes! I designed and coded this webpage from the ground-up, with a bit of help from my dad (and some fantastic YouTube lessons). test123
			</div>
		</section>
		<p></p>
	</main>
